      ...
      <div className="flex items-center justify-center border w-full h-lvh">
        <div className="w-80 h-96 shadow-sm shadow-slate-200 border border-slate-200 rounded-3xl flex flex-col items-center justify-evenly">
          ...
          <div className="text-center flex flex-col gap-4">
            <input type="text" name="username" id="username" placeholder="Username" className="border w-72 h-10 pl-2 text-xl border-slate-300" />
            <input type="text" name="password" id="password" placeholder="Password" className="border w-72 h-10 pl-2 text-xl border-slate-300"/>
          </div>
